<?php
    ...
    $pesquisaResidencia = $_POST["pesquisa"];

    //comando sql
    $sql = "SELECT * FROM agentesprosaude.Residencia 
    WHERE cpf_agente = $cpfAgente 
    and endereco like '%$pesquisaResidencia%'
    or complemento like '%$pesquisaResidencia%'
    or bairro like '%$pesquisaResidencia%'
    or ID_residencia like '%$pesquisaResidencia%'
